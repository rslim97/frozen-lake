...
# define a function to perform first-visit Monte Carlo control without exploring starts
def monteCarloControl(env,n_episodes=20000,policy=None,epsilon=0.01):
    if not policy:
...
def main():
    ...
    policy=monteCarloControl(env,n_episodes=20000)
    print('policy=',policy)
